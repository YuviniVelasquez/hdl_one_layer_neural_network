...
# Table of Contents
1. [Introduction](#)
    1. [Machine Learning and Artificial Neaural Network]()
    2. [Mathematical Representation of an Artificial Neural Network]()
    3. [Key specifications and Constraints]()
    4. [Results]()
2. [Micro-Architecture](#example2)
    1. [Hardware algorithmic approach]()
    2. [High Level Architecture and Schematics]()
    3. [Synthesis with Design Vision]()
3. [Interface Specification](#third-example)
    1. [One Layer Neural Network]()
    2. [SRAM setup]()
4. [Technical Implementation](#fourth-examplehttpwwwfourthexamplecom)
5. [Debug and Verification](#fourth-examplehttpwwwfourthexamplecom)
6. [Results Achieved](#fourth-examplehttpwwwfourthexamplecom)
7. [Conclusions](#fourth-examplehttpwwwfourthexamplecom)
...
<div style="text-align:center"><img src="Images/nn_matrix.jpg" /></div>
<div style="text-align:center">Neural Network and Matrix Equivalent</div>
